...
void MecanumChassisInit(MecanumChassis* chassis, BasePID_Object run_pid, CanNumber canx)
{
	...
	chassis->Movement.Vomega_Sensitivity = 6;
	chassis->Movement.Vx_Sensitivity     = 3;
	chassis->Movement.Vy_Sensitivity     = -3;
}
...
/**
  ...
  */
void MecanumChassisGetRemoteData(MecanumChassis* chassis, RC_Ctrl_ET* rc_Ctrl)
{
...
/**
  * @brief  麦轮底盘发送电机控制数据
  */
void MecanumChassisOutputControl(MecanumChassis* chassis, RC_Ctrl_ET* rcCtrl)
{
