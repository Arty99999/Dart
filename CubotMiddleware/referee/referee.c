...
uint8_t bullet_num_17mm=0;
uint8_t bullet_num_42mm=0;
/**
  * @brief   串口2裁判系统回调函数 
  * @param[in]  
  */
...
//		BYTE1(power_heat_data.shooter_id2_17mm_cooling_heat) = *(pdata + data_addr + 13);
		...
		BYTE0(referee2022.power_heat_data.shooter_id1_42mm_cooling_heat) = *(pdata + data_addr + 14);//42毫米枪口
...
uint8_t ref_packge[packs][max_single_pack_len];  //最多一次收15个包,超过必会发生数组溢出
...
void Data_to_server()
{
	...
	Data[0]=0xAA;
	Data[1]=referee2022.game_robot_status.robot_id;
	
	Data[2]=referee2022.game_robot_status.remain_HP&0xFF;
	Data[3]=referee2022.game_robot_status.remain_HP>>8;
	
	memcpy(&Data[4],&referee2022.power_heat_data.chassis_power,4);
	
	Data[8]=referee2022.power_heat_data.chassis_power_buffer&0xFF;
	Data[9]=referee2022.power_heat_data.chassis_power_buffer>>8;
	
	Data[10]=referee2022.power_heat_data.shooter_id1_17mm_cooling_heat&0xFF;
	Data[11]=referee2022.power_heat_data.shooter_id1_17mm_cooling_heat>>8;
	
	Data[12]=referee2022.power_heat_data.shooter_id1_42mm_cooling_heat&0xFF;
	Data[13]=referee2022.power_heat_data.shooter_id1_42mm_cooling_heat>>8;
	
	Data[14]=bullet_num_17mm;
  Data[15]=bullet_num_42mm;
	
	HAL_UART_Transmit_DMA(&huart7,Data,16); 
